 ...
 */
@Controller
public class LiteOmpAPIAction extends BaseAction {

	private Log log = LogFactory.getLog(this.getClass());
	@Autowired
	private LiteOmpRestClientImpl liteOmpRestClientImpl;
	
	@RequestMapping(value="/sample/LiteOmpAPIAction/APITest")
	...
	@RequestMapping(value="/sample/couponTest")
	public String testPage(@RequestParam String couponNo) throws Exception {
		return "/test/coupontest";
	}
